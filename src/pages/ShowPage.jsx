...
import videogames from "../assets/videogames.js";
...
export default function ShowItemPage() {
  ...
  if (page === "videogames") {
    response = videogames.find((game) => game.id === id);
  }
  if (page === "movies") {
    response = movies.find((movie) => movie.id === id);
  }
  if (page === "songs") {
    response = songs.find((song) => song.id === id);
  }
  if (page === "books") {
    response = books.find((book) => book.id === id);
  }
